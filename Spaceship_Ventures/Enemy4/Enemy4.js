...
export default class Enemy4 extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("costume1", "./Enemy4/costumes/costume1.svg", {
        x: 543.5,
        y: 25.286930159406694
      }),
      new Costume("costume2", "./Enemy4/costumes/costume2.svg", {
        x: 25.19502342533457,
        y: 25.30933211496273
      }),
      new Costume("costume3", "./Enemy4/costumes/costume3.svg", {
        x: 32.429084999999986,
        y: 26.38399665371543
      }),
      new Costume("costume4", "./Enemy4/costumes/costume4.svg", {
        x: 33.13193418145755,
        y: 28.417599999999993
      }),
      new Costume("costume5", "./Enemy4/costumes/costume5.svg", {
        x: 41.03296,
        y: 32.43482
      }),
      new Costume("costume6", "./Enemy4/costumes/costume6.svg", {
        x: 41.07627500000001,
        y: 37.30084500000001
      })
    ];

    this.sounds = [new Sound("pop", "./Enemy4/sounds/pop.wav")];
  ...
  *whenIReceiveRestart5() {
    ...
    while (true) {
      if (this.random(1, 4) === 2) {
        ...
        this.costume = "costume2";
        yield* this.broadcastAndWait("enemy shoot 4");
      } else {
        yield* this.wait(1);
      }
      yield;
  ...
  *whenIReceiveRestart6() {
    while (true) {
      if (this.touching(this.sprites["Sprite2"].andClones())) {
        ...
        this.broadcast("death message 4");
